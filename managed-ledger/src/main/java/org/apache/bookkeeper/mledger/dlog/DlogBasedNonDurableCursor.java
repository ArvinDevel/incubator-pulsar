...
public class DlogBasedNonDurableCursor extends DlogBasedManagedCursor {
    ...
    /// Overridden methods from DlogBasedManagedCursor. Void implementation to skip cursor persistence
    ...
    private static final Logger log = LoggerFactory.getLogger(DlogBasedNonDurableCursor.class);
}
